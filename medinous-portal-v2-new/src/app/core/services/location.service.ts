...
const CLINIC_LOCATIONS: ClinicLocation[] = [
  {
    id: 'loc-001', name: 'Good Health Hospital - Juffair',
  ...
  {
    id: 'loc-002', name: 'GHH Medical Centre - Seef',
  ...
  {
    id: 'loc-003', name: 'GHH Clinic - Riffa',
  ...
  {
    id: 'loc-004', name: 'GHH Clinic - Muharraq',
