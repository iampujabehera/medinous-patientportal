      ...
      <div class="sp-modal" (click)="$event.stopPropagation()"
        ...
        <header class="sp-modal-head">
          ...
          <div class="sp-modal-head-text">
            ...
            <span>
              @if (addFormOpen()) {
                Link an existing hospital patient to your account
              } @else {
        ...
        @if (!addFormOpen()) {
          ...
          <div class="sp-add-form">
            ...
            <p class="sp-add-hint">
              ...
              <strong>Patient ID</strong> from the hospital to link their
...
export class SelectPatientComponent {
  ...
  submitAdd(): void {
    ...
    this.snackBar.open(
      `${p.firstName} will appear once the hospital verifies.`,
      undefined,
      { duration: 5000 }
    );
    this.cancelAdd();
